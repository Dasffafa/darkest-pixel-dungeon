...
public class Group extends Gizmo {
  ...
  public ArrayList<Gizmo> members;
  ...
  public synchronized void update() {
    for (int i = 0; i < length; i++) {
      ...
      if (g != null && g.exists && g.active
              //functionality for the freezing of emitters(particle effects),
              // effects are given a second
              //from load to get started so they aren't frozen before 
              // anything is generated.
              && !(freezeEmitters && Game.timeTotal > 1f && g instanceof 
              Emitter)) {
        g.update();
      }
    }
