...
public class Matrix {
	...
	public static void multiply( float[] left, float right[], float[] result ) {
		final float ax1 = left[0], ay1 = left[1], az1 = left[2], aw1 = left[3];
		final float ax2 = left[4], ay2 = left[5], az2 = left[6], aw2 = left[7];
		final float ax3 = left[8], ay3 = left[9], az3 = left[10], aw3 = left[11];
		final float ax4 = left[12], ay4 = left[13], az4 = left[14], aw4 = left[15];
		final float bx1 = right[0], by1 = right[1], bz1 = right[2], bw1 = right[3];
		final float bx2 = right[4], by2 = right[5], bz2 = right[6], bw2 = right[7];
		final float bx3 = right[8], by3 = right[9], bz3 = right[10], bw3 = right[11];
		final float bx4 = right[12], by4 = right[13], bz4 = right[14], bw4 = right[15];
