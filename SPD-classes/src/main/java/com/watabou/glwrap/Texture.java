...
public class Texture {
	...
	/** Invalidates the wrapper cache after a texture is bound outside this class. */
	...
	public void bitmap( Pixmap bitmap ) {
		bind();
		Gdx.gl.glTexImage2D(
				Gdx.gl.GL_TEXTURE_2D, 0, bitmap.getGLInternalFormat(),
				bitmap.getWidth(), bitmap.getHeight(), 0, bitmap.getGLFormat(),
				bitmap.getGLType(), bitmap.getPixels());
