...
public class PixelScene extends Scene {
  ...
  public void create() {
    ...
    maxDefaultZoom = (int) Math.min(Game.width / minWidth, Game.height / 
            minHeight);
    defaultZoom = DarkestPixelDungeon.scale();

    if (defaultZoom < Math.ceil(Game.density * 2) || defaultZoom > 
            maxDefaultZoom) {
    ...
    if (pixelFont == null) {
      ...
      pixelFont = Font.colorMarked(
              BitmapCache.get(Assets.PIXELFONT), 0x00000000, BitmapText.Font
                      .LATIN_FULL);
      ...
      font1x = Font.colorMarked(
              BitmapCache.get(Assets.FONT1X), 22, 0x00000000, BitmapText.Font
                      .LATIN_FULL);
      font1x.baseLine = 17;
      font1x.tracking = -2;
      ...
      font2x = Font.colorMarked(
              BitmapCache.get(Assets.FONT2X), 44, 0x00000000, BitmapText.Font
                      .LATIN_FULL);
      font2x.baseLine = 38;
      font2x.tracking = -4;
