...
public class AmuletScene extends PixelScene {
  ...
  public void create() {
    ...
    if (noText) {
      ...
      text.setPos((Camera.main.width - text.width()) / 2, amulet.y + amulet
              .height + LARGE_GAP);
      align(text);

      btnExit.setPos((Camera.main.width - btnExit.width()) / 2, text.top() + 
  ...
  protected void onBackPressed() {
    InterlevelScene.Companion.setMode(InterlevelScene.Mode.CONTINUE);
