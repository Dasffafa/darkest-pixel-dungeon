...
//            val wnd = WndOptions.Show(Icons.WARNING.get(), M.L(this, "qq_title"), M.L(this, "qq_desc")) {}
    ...
    fun joinQQGroup(key: String): Boolean {
        return try {
            Game.platform.openURI("mqqopensdkapi://bizAgent/qm/qr?url=http%3A%2F%2Fqm.qq.com%2Fcgi-bin%2Fqm%2Fqr%3Ffrom%3Dapp%26p%3Dandroid%26jump_from%3Dwebapi%26k%3D$key")
        } catch (e: Exception) {
            // 未安装手Q或安装的版本不支持
            false
        }
