...
import com.egoal.darkestpixeldungeon.effects.ShadowBox;
...
public class Window extends Group implements Signal.Listener<Key> {
  ...
  public static final int DPD_COLOR = 0x6C34A8;
  ...
  public void resize(int w, int h) {
    ...
    shadow.boxRect(camera.x / camera.zoom, camera.y / camera.zoom, chrome
            .width(), chrome.height);
  }
