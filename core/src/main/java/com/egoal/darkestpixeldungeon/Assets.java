...
public class Assets {
    ...
    public static final String ROTTEN = ACTORS + "rotten.png";
    ...
    public static final String TRACK_FINAL_INTRO = SOUNDS + "track_final_intro" +
            ".ogg";
    ...
    public static final String SND_MOONLIGHT = SOUNDS + "snd_moonlight.ogg";
    public static final String SND_HIT2 = SOUNDS + "snd_hit2.ogg";
